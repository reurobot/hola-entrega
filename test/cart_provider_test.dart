  ...
  group('CartProvider Tests', () {
    ...
    test('should apply individual discounts correctly', () {
      final product1 = SectionModel(
        ...
        perItemPrice: 100.0,
        qty: '2',
        descuentoPorcentaje: 0.1, // 10% discount
        precioConDescuento: 90.0, // 100 * 0.9
        originalPrice: 100.0,
      );
      ...
      final product2 = SectionModel(
        ...
        perItemPrice: 50.0,
        qty: '3',
        descuentoPorcentaje: 0.2, // 20% discount
        precioConDescuento: 40.0, // 50 * 0.8
        originalPrice: 50.0,
      );
