...
AppBar getAppBar(String title, BuildContext context, Function setState,
  ...
  return AppBar(
    ...
    actions: <Widget>[
      title == 'FAVORITE'.translate(context: context)
          ? const SizedBox()
          : GestureDetector(
              child: Padding(
                padding: EdgeInsets.only(left: size * 0.02),
                child: SvgPicture.asset(
                  DesignConfiguration.setSvgPath(Assets.deselFav),
