...
class DesignConfiguration {
  static String setSvgPath(String name) {
    return 'assets/images/svg/$name.svg';
  }

  static String setPngPath(String name) {
    return 'assets/images/png/$name.png';
  }

  static String setLottiePath(String name) {
  ...
  static Widget erroWidget(double size) {
    return Image.asset(
      DesignConfiguration.setPngPath(Assets.placeholder),
      height: size,
      width: size,
    );
  }
  ...
  static Widget imagePlaceHolder(double size, BuildContext context) {
    return SizedBox(
      height: size,
      width: size,
      child: Icon(
  ...
  static String? getPriceFormat(BuildContext context, double price) {
    final decimalDigits = int.tryParse(DECIMAL_POINTS ?? '') ?? 0;
    ...
    try {
      ...
      print('Price formatting error: $e');
      return price.toStringAsFixed(decimalDigits);
    }
  }
  ...
  static Widget getCacheNotworkImage({
    ...
    return FadeInImage.assetNetwork(
      ...
      placeholder: DesignConfiguration.setPngPath(Assets.placeholder),
      width: widthvalue,
      height: heightvalue,
      fit: boxFit,
...
class GetDicountLabel extends StatelessWidget {
  ...
  const GetDicountLabel({super.key, required this.discount});
