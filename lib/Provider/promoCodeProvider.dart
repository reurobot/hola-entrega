...
class PromoCodeProvider extends ChangeNotifier {
  ...
  List<Promo> personalizedPromoAvailable = [];
  String errorMessage = '';
  ...
  //This method is used to fetch personalized Promo Codes for authenticated user
  Future<void> getPersonalizedPromoCodes({required String productId, required String userId}) async {
    try {
      //Simulate
      var parameter = {
      ...
      Map<String, dynamic> result =
      await PromoCodeRepository.fetchPersonalizedPromoCodes(parameter: parameter);
      List<Promo> tempList = [];
      ...
      personalizedPromoAvailable = tempList;
