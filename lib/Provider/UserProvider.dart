...
class UserProvider extends ChangeNotifier {
  ...
  int? get userIdErp => _userIdErp;
  String? get customerErpId => _customerErpId;
  ...
  void setCreatedAt(String? createdAtString) {
    _createdAt = createdAtString != null && createdAtString.isNotEmpty
        ? DateTime.tryParse(createdAtString)
        : null;
    notifyListeners();
  }

  void setUserIdErp(String? userIdErpString) {
    _userIdErp = userIdErpString != null && userIdErpString.isNotEmpty
        ? int.tryParse(userIdErpString)
        : null;
    notifyListeners();
  }
  ...
  Future<Map<String, dynamic>?> deleteUserAccount({
    ...
    try {
      var parameter = {MOBILE: mobileNumber, PASSWORD: password};
