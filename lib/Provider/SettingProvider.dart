...
class SettingProvider {
  ...
  String? get createdAt => _sharedPreferences.getString(CREATED_AT);

  String? get userIdErp => _sharedPreferences.getString(USER_ID_ERP);
  ...
  Future<void> saveUserDetail(
    ...
    waitList.add(_sharedPreferences.setString(CREATED_AT, createdAt ?? ''));
    waitList.add(_sharedPreferences.setString(USER_ID_ERP, userIdErp ?? ''));
    ...
    userProvider.setCreatedAt(createdAt);
    userProvider.setUserIdErp(userIdErp);
