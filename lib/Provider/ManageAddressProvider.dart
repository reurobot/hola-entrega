          ...
          if (IS_SHIPROCKET_ON == '0') {
            if (!ISFLAT_DEL) {
              if (context.read<CartProvider>().totalPrice <
                ...
                print(
                    "deliverychargedinvalid------>${context.read<CartProvider>().deliveryCharge}--------${context.read<CartProvider>().addressList[i].deliveryCharge!}");
                context.read<CartProvider>().deliveryCharge = double.parse(
                    context
                        ...
                        .deliveryCharge!);
                print(
                    "deliverychargedinvalid------>11111${context.read<CartProvider>().deliveryCharge}");
              } else {
