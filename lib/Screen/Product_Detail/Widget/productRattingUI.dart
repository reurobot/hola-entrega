...
class StarRatingProductDetailPage extends StatelessWidget {
  ...
  Widget getHalfStar(String value) {
    return value == '1' || value == '2' || value == '3'
        ? getSVGImage(Assets.dStar)
        : value == '4' || value == '5' || value == '6'
            ? getSVGImage(Assets.cStar)
            : value == '7' || value == '8' || value == '9'
                ? getSVGImage(Assets.bStar)
                : getSVGImage(Assets.eStar);
  }
    ...
    return Row(
      children: [
        ...
        needToShowNoOfRatings
            ? Flexible(
                child: Text(
                  '|  $noOfRatings ${'Rattings'.translate(context: context)}',
                  style: TextStyle(
