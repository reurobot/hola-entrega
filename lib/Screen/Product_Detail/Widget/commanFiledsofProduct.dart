...
class GetNameWidget extends StatelessWidget {
  ...
  const GetNameWidget({super.key, required this.name});
...
class GetTitleWidget extends StatelessWidget {
  ...
  const GetTitleWidget({super.key, required this.title});
...
class GetIncludeTaxWidget extends StatelessWidget {
  const GetIncludeTaxWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Text(
        "(${'INCLUDED_TAX'.translate(context: context)})",
...
class GetPrice extends StatelessWidget {
  ...
  GetPrice({super.key, this.from, this.pos, this.model});
...
class GetRatttingWidget extends StatelessWidget {
  ...
  final String noOfRatting;

  const GetRatttingWidget(
...
Widget getDivider(double height, BuildContext context) {
  return Divider(
    height: height,
...
class SaveExtraWithOffers extends StatelessWidget {
  ...
  const SaveExtraWithOffers({super.key, required this.update});
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  'Save extra with offers'.translate(context: context),
                  style: TextStyle(
                    color: Theme.of(context).colorScheme.black,
...
class SimmerSingleLine extends StatelessWidget {
  const SimmerSingleLine({super.key});
