...
class _FavProductDataState extends State<FavProductData> {
          ...
          children: <Widget>[
            ...
            if (cartBtnList)
              context
                              ...
                              .text ==
                          '0' &&
                      (widget.favList[widget.index!].availability == '' ||
                          widget.favList[widget.index!].availability == '1')
                  ? _buildAddCartSection()
                  : const SizedBox(),
            context
                        .read<FavoriteProvider>()
                        .controllerText[widget.index!]
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: const BorderRadiusDirectional.only(
                      bottomEnd: Radius.circular(circularBorderRadius7),
                      topEnd: Radius.circular(circularBorderRadius7),
                    ),
                  ),
                  child: Icon(
                    Icons.add,
  ...
  Widget _buildCartActionSection() {
    return Row(
      children: <Widget>[
        InkWell(
          child: Container(
            ...
            children: [
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (String value) {
                  if (context.read<UpdateFavProvider>().getCurrentStatus !=
                      UpdateFavStatus.inProgress) {
                    addToCart(value, 2, context);
                  }
                },
                itemBuilder: (BuildContext context) {
                  return widget.favList[widget.index!].itemsCounter!
