...
class _CompareListState extends State<CompareList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: getAppBar(
          'COMPARE_PRO'.translate(context: context), context, setStateNow),
          ...
          child: InkWell(
            child: Column(
              ...
              children: <Widget>[
                ...
                commanField(
                    madeIn, 'MADE_IN'.translate(context: context), context),
                commanField(
                    warranty, 'WARRENTY'.translate(context: context), context),
                commanField(gaurantee, 'GAURANTEE'.translate(context: context),
                    context),
