...
class _CartIteamState extends State<CartIteam> {
  ...
  Widget build(BuildContext context) {
    ...
    if (cartList[index].originalPrice == 0.0) {
    ...
    if (cartList[index].descuentoPorcentaje != null && 
      ...
      cartList[index].precioConDescuento = price;
    }

    cartList[index].perItemPrice = finalPrice.toString();
    cartList[index].perItemTotal =
        (finalPrice * double.parse(cartList[index].qty!)).toString();
