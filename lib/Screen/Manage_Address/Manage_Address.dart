...
class ManageAddress extends StatefulWidget {
  ...
  const ManageAddress({super.key, this.home});
...
class StateAddress extends State<ManageAddress> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar:
          getSimpleAppBar('SHIPP_ADDRESS'.translate(context: context), context),
                    ...
                    builder: (context, value, child) {
                      if (value.getCurrentStatus ==
                        ...
                        return context.read<CartProvider>().addressList.isEmpty
                            ? Center(
                                child: Text(
                                  'NOADDRESS'.translate(context: context),
        ...
        RadioModel(
          ...
          onSetDefault: () {
            if (context.read<CartProvider>().addressList[i].isDefault != '1') {
              ...
              setSnackbar('Already_set_as_default'.translate(context: context),
                  context);
            }
          },
          onDeleteSelected: () {
            showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  title: Text(
                    'YOU_WANT_TO_DELETE_THE_ADDRESS'
