...
class WithdrawRequestItem extends StatelessWidget {
  ...
  WithdrawRequestItem({super.key, required this.withdrawItem});
          ...
          child: Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Text(
                    "${"AMOUNT".translate(context: context)} : ${DesignConfiguration.getPriceFormat(context, double.parse(withdrawItem.amountRequested!))!}",
                    style: TextStyle(
              ...
              Row(
                ...
                children: <Widget>[
                  Text(
                    "${"ID_LBL".translate(context: context)} : ${withdrawItem.id!}",
                    style: const TextStyle(
                      fontFamily: 'ubuntu',
                    ),
                  ),
              ...
              withdrawItem.paymentAddress != null &&
                  ...
                  ? Text(
                      "${"Payment Address".translate(context: context)} : ${withdrawItem.paymentAddress!}.",
                      style: const TextStyle(
                        fontFamily: 'ubuntu',
                      ),
                    )
              ...
              withdrawItem.paymentType != null &&
                  ...
                  ? Text(
                      "${"Payment Type".translate(context: context)} : ${withdrawItem.paymentType!}",
                      style: const TextStyle(
                        fontFamily: 'ubuntu',
                      ),
                    )
              ...
              withdrawItem.remarks != null
                  ? Text(
                      '${'Remark'.translate(context: context)}: ${withdrawItem.remarks}',
                      style: const TextStyle(
                        fontFamily: 'ubuntu',
                      ),
                    )
