...
class ShowContentOfSellers extends StatelessWidget {
  ...
  ShowContentOfSellers({super.key, required this.sellerList});
                  ...
                  child: ListTile(
                    ...
                    subtitle: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            ' | ${sellerList[index].totalProductsOfSeller} ${'PRODUCTS'.translate(context: context)} ',
                            style: const TextStyle(
                              fontWeight: FontWeight.w400,
                              fontStyle: FontStyle.normal,
        ...
        : Selector<HomePageProvider, bool>(
            builder: (context, data, child) {
              return !data
                  ? Center(
                      child: Text(
                        'No Seller/Store Found'.translate(context: context),
                        style: const TextStyle(
                          fontFamily: 'ubuntu',
                        ),
                      ),
