...
class _FaqsListState extends State<FaqsList> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      key: _scaffoldKey,
      appBar: getSimpleAppBar('FAQS'.translate(context: context), context),
  ...
  Widget showContent(List<FaqsModel>? faqList) {
  ...
  Widget listItem(List<FaqsModel> faqsList, int index) {
    return Card(
      elevation: 0,
      child: InkWell(
