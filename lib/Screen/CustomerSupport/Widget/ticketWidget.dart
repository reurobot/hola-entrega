...
class TicketIteamWidget extends StatefulWidget {
  int index;
  Function updateNow;
  TicketIteamWidget({super.key, required this.index, required this.updateNow});
            ...
            children: [
              Row(
                children: [
                  Expanded(
                    child: Text(
                      '${'Type'.translate(context: context)} : ${context.read<CustomerSupportProvider>().ticketList[widget.index].type!}',
              ...
              Text(
                '${'TITLE'.translate(context: context)} : ${context.read<CustomerSupportProvider>().ticketList[widget.index].title!}',
                style: const TextStyle(
                  fontFamily: 'ubuntu',
                ),
              ),
              Text(
                '${'DESCRIPTION'.translate(context: context)} : ${context.read<CustomerSupportProvider>().ticketList[widget.index].desc!}',
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: const TextStyle(
                  fontFamily: 'ubuntu',
              ...
              Text(
                '${'DATE'.translate(context: context)} : ${context.read<CustomerSupportProvider>().ticketList[widget.index].date!}',
                style: const TextStyle(
                  fontFamily: 'ubuntu',
                ),
              ),
