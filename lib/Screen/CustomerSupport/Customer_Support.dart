import 'dart:async';
import 'package:eshop_multivendor/Screen/CustomerSupport/Widget/setTypeWidget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: getSimpleAppBar(
          'CUSTOMER_SUPPORT'.translate(context: context), context),
  ...
  void validateAndSubmit() async {
    if (context.read<CustomerSupportProvider>().edit) {
      if ((context.read<CustomerSupportProvider>().type == null ||
        ...
        setSnackbar('Please Select Type'.translate(context: context), context);
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          hintText: 'DESCRIPTION'.translate(context: context),
  ...
  Widget sendButton() {
    return Padding(
      ...
      child: SimBtn(
        ...
        size: 0.4,
        title: 'SEND'.translate(context: context),
        onBtnSelected: () {
          validateAndSubmit();
        },
      ),
