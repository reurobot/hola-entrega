...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff2DA030);
  static const Color secondary = Color(0xffE9730F);
  ...
  static const Color grad1Color = Color.fromARGB(255, 127, 229, 130);
  static const Color grad2Color = Color(0xff2DA030);
