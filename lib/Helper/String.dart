...
//TODO Replace content with the API ENDPOINT to get the Slider products
final Uri getProductSlideApi = Uri.parse('${baseUrl}get_products_by_slider');
...
//TODO Replace content with the API ENDPOINT to get the promo codes for the user
final Uri getPersonalizedPromoCodeApi = Uri.parse('${baseUrl}get_promo_codes');
...
final Uri getPredefiendReasonsApi =
    Uri.parse('${baseUrl}get_predefiend_reasons');
...
const String getUsersSearchApi = '${baseUrl}get_users_search';
...
const String CUSTOMER_ID_ERP = 'customer_id_erp';
...
const String USER_ID_ERP = 'user_id_erp';
...
bool singleSellerOrderSystem = true;
bool forLoginPageSingleSellerSystem = true;
bool homePageSingleSellerMessage = true;
bool SINGLE_SELLER_SYSTEM = true;
